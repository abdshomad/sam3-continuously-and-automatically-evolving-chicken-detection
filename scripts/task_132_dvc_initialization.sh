#!/bin/bash
# Task ID: 1.3.2
# Description: DVC Initialization (Wrapper Script)
# Created: 2025-12-12

set -e

echo "=========================================="
echo "Task 1.3.2: DVC Initialization"
echo "=========================================="
echo ""
...
PYTHON_SCRIPT="scripts/task_132_dvc_initialization.py"
...
echo "Running DVC initialization script..."
echo ""

if uv run python "$PYTHON_SCRIPT"; then
    echo ""
    echo "✓ DVC initialization script completed successfully"
    exit 0
else
    echo ""
    echo "ERROR: DVC initialization script failed"
    exit 1
fi
