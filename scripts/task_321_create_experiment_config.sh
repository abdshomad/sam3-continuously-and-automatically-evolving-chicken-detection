#!/bin/bash
# Task ID: 3.2.1
# Description: Create Experiment Config (Wrapper Script)
# Created: 2025-12-12

set -e

echo "=========================================="
echo "Task 3.2.1: Create Experiment Config"
echo "=========================================="
echo ""
...
PYTHON_SCRIPT="scripts/task_321_create_experiment_config.py"
...
echo "Running experiment config creation script..."
echo ""

if "$PYTHON_EXE" "$PYTHON_SCRIPT"; then
    echo ""
    echo "✓ Experiment config creation script completed successfully"
    exit 0
else
    echo ""
    echo "ERROR: Experiment config creation script failed"
    exit 1
fi
