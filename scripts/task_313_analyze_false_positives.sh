...
# Check if required Python packages are installed (python-dotenv should be in pyproject.toml)
if ! "$PYTHON_EXE" -c "import dotenv" 2>/dev/null; then
    echo "WARNING: python-dotenv not found in virtual environment"
    echo ""
