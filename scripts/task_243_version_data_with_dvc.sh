...
if [ ! -d "data/images" ]; then
    ...
    uv run python -m dvc add data/images
...
if [ -d "data/annotations" ]; then
    ...
    uv run python -m dvc add data/annotations
...
if [ -f "data/chicken_train.json" ]; then
    ...
    uv run python -m dvc add data/chicken_train.json
...
if [ -f "data/chicken_val.json" ]; then
    ...
    uv run python -m dvc add data/chicken_val.json
