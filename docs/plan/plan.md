...
| :---- | :---- | :---- | :---- | :---- |
| **1.1.1** | **GPU Availability Check** | Run `nvidia-smi`. Verify GPU model (Target: A100/H100 or RTX 3090/4090). Ensure Driver Version $\\ge$ 525.xx. | \[x\] Failed | 2024-07-17 |
| **1.1.2** | **CUDA Toolkit Verification** | Run `nvcc --version`. Ensure compatibility with PyTorch 2.x (Target: CUDA 11.8 or 12.1). | \[x\] Failed | 2024-07-17 |
| **1.1.3** | **VRAM Health Check** | Ensure no other processes are consuming VRAM. For 24GB cards, ensure 100% availability. | \[x\] Failed | 2024-07-17 |
